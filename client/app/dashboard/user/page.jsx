...
const UserPage = () => {
    ...
    return ( 
        <div className="">
            <div className="text-blue-900 text-3xl mb-5 font-semibold">User List</div>
                ...
                <tbody>
                    {userData.map(data => (
                        <tr key={data._id}>
                            ...
                            <td className={`${border1} pl-2 text-center`}>{data.province}</td>
                            <td className={`${border1} pl-2 text-center`}>{data.phone}</td>
                            <td className={`${border1} pl-2 text-center`}>{data.email}</td>
                            <td className={`${border1} pl-2 text-center p-2 flex justify-center`}>
                                <Link href={`/dashboard/user/${data._id}`} className="flex bg-slate-400 p-2 gap-1 rounded-lg text-white hover:bg-red-800">
