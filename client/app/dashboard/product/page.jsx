      ...
      {loading ? (
        ...
        <div>
          <Link
            ...
            className="bg-blue-900 text-white rounded-md py-1 px-2 w-2/12 text-center"
          >
            Add New Product
          </Link>
          <table
            className={`table-auto border-collapse ${border1} w-11/12 mt-5`}
          >
            <thead>
              <tr className="bg-blue-900 text-white text-center">
                ...
                <td className={border2}>Quantity</td>
                ...
                return (
                  <tr key={product._id}>
                    ...
                    >
                      ...
                      <Link
                        href={`/dashboard/product/delete/${product._id}`}
                        className="flex bg-slate-400 p-2 gap-1 rounded-lg text-white hover:bg-rose-700"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
